'use strict';Object.defineProperty(exports,'__esModule',{value:true});const Life$1 = {
    /**
     * @name Animals
     ...
     */
    passTime: () => {
        Life$1.Animals.forEach((animal) => animal.ageUp());
    },
};var Names = new (class Names {
    pickRandom(list) {
     ...
     * @returns {string}
     */
    generateName(gender, first = false) {
        const firstNames = this.fetchNames(gender || this.pickRandom(["male", "female"]));
...
}exports.Bird=Bird;exports.Fish=Fish;exports.Human=Human;exports.Life=Life$1;